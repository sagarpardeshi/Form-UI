    <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="">
      <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
          <a href="/">
            <img src="{{ asset('assets/static/brands/twitter.svg') }}" width="148" height="32" alt="Tabler" class="navbar-brand-image" />
          </a>
        </h1>
        <div class="navbar-nav flex-row d-lg-none">
          ...
          <div class="d-none d-lg-flex">
            ...
            <div class="nav-item dropdown d-none d-md-flex me-3">
              <a href="{{ route('dashboard') }}" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications">
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
              ...
              <div class="d-none manage-profile">
                <div>Paweł Kuna</div>
          ...
          <ul class="navbar-nav pt-lg-3">
            ...
            <li class="nav-item {{ request()->routeIs('forms.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('forms.index') }}">
                ...
                <span class="nav-link-title"> Form </span>
              </a>
            </li>
            ...
            <li class="nav-item {{ request()->routeIs('submissions.*') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('submissions.index') }}">
                ...
                <span class="nav-link-title"> Submission </span>
              </a>
            </li>

            <li class="nav-item {{ request()->routeIs('billing') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('billing') }}" role="button">
                <i class="nav-link-icon d-md-none d-lg-inline-block icon las la-money-bill"></i>
            ...
            <div class="mt-auto mb-5">
              <li class="nav-item {{ request()->routeIs('config') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('config') }}">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-adjustments" width="44"
              ...
              <li class="nav-item">
                <a class="nav-link" href="/sign-in" role="button">
                  <i class="nav-link-icon d-md-none d-lg-inline-block icon las la-sign-out-alt"></i>
